...
mod_display_plot_ui <- function(id, plot_label, additional_data_info = NULL) {
  ns <- NS(id)
  div(
...
# mod_display_plot_ui("plot_and_data_section_1")

## To be copied in the server
# mod_display_plot_server("plot_and_data_section_1")
